...
\subsubsection{Analizarea leg'aturilor}
\subsubsection{Extragerea informa'tiei}
\subsubsection{Clasificarea}
...
\subsection{Ignorarea termenilor cu ponderi mici}
\subsection{Listele de campioni}%??ih
