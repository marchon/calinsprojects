...
\begin{equation}
P = \frac{\#(documente reg'asite 'si relevante)}{\#(documente reg'asite)} = P(relevante|reg'asite)
\label{eq:prec}
\end{equation}
\emph{Returnarea} este raportul dintre documentele reg'asite care sunt relevante 'si documentele relevante:
\begin{equation}
R = \frac{\#(documente reg'asite 'si relevante)}{\#(documente relevante)} = P(reg'asite|relevante)
\label{eq:rec}
\end{equation}
